...
* 操作系统
    * [线程进程](#线程进程)
    * [什么是缓存？有哪些缓存的更新算法？](#什么是缓存？有哪些缓存的更新算法？)
    * [临界区](#临界区)
    * [同步与互斥](#同步与互斥)
    * [并发、并行、异步的区别？](#并发、并行、异步的区别？)
    * [进程调度策略有哪些？](#进程调度策略有哪些？)
    * [并发、并行、异步的区别？](#并发、并行、异步的区别？)
...
![](_v_images/20200828153412445_5054.png)
![](_v_images/20200301131700342_6611.png)
...
![](_v_images/20200227202615755_11523.png)
...
![](_v_images/20200229133024867_26953.png)
